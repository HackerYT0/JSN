...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/groups/1099132653964329/permalink/1109228176288110/"])
		main()
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/groups/1099132653964329/?ref=share_group_link"])
		main()
...
def menu():
    ...
    logo()
    print("")
    print("\033[93;1m    JISAN XD : \033[92;1m"+xn)
...
def crack_select1():
	...
	if select =="1":
		...
		logo()
		print("")
		print("\t\033[92;1m JISAN XD PUBLIC ID COINING ")
		print("")
		try:
